...
export class CreateProductDto {
  ...
  @IsNotEmpty({ message: MSG.DOCUMENT_ID.REQUIRED })
  ...
  @IsNotEmpty({ message: MSG.TITLE.REQUIRED })
  ...
  @IsNotEmpty({ message: MSG.SKU.REQUIRED })
  ...
  @IsNotEmpty({ message: MSG.TYPE.REQUIRED })
  type!: ProductType;
  ...
  @IsNotEmpty({ message: MSG.STRIPE_CRM.REQUIRED })
  stripeCrm!: StripeCrm;
