export const CONTROLLER_TEMPLATE = (resourceName: string, resourceNameLower: string) => `
import { BaseController } from '@common/GlobalController.js';
import { MODELS_NAMES } from '@constants/common/models.js';
import { ${resourceName}Service } from '@/api/${resourceNameLower}/${resourceNameLower}Service.js';
import { type ${resourceName} } from '@/api/${resourceNameLower}/${resourceNameLower}Model.js';

export class ${resourceName}Controller extends BaseController<${resourceName}> {
  constructor() {
    super(${resourceName}Service, MODELS_NAMES.${resourceName.toUpperCase()});
  }
...
export const SERVICE_TEMPLATE = (resourceName: string, resourceNameLower: string) => `
...
import { ${resourceName} } from '@/api/${resourceNameLower}/${resourceNameLower}Model.js';
...
export const ROUTES_TEMPLATE = (resourceName: string, resourceNameLower: string) => `
...
import { ${resourceNameLower}Controller } from '@/api/${resourceNameLower}s/${resourceNameLower}Controller.js';

// import { Create${resourceName}Dto } from '@/api/${resourceNameLower}s/dtos/Create${resourceName}Dto.js';
// import { Update${resourceName}Dto } from '@/api/${resourceNameLower}s/dtos/Update${resourceName}Dto.js';
// import { Query${resourceName}Dto } from '@/api/${resourceNameLower}s/dtos/Query${resourceName}Dto.js';
